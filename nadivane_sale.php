                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="breadcrumbs">
                            ...
                            <li class="breadcrumbs_it">
                                <span class="breadcrumbs_current">Действующие акции</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <article class="catalog_box b-white">
                            ...
                            <div>
                                <div class="sale_stock clearfix1">
                                    <div class="sale_stock-col1 f_left">
                                        <img class="img-stock" src="images/nadivane_sale1.jpg" alt="">
                                    </div>
                                    <div class="sale_stock-col2 w42p f_left">
                                        <h3 class="img_main-text">
                                            Неделя в Тайланде для всей семьи при покупке мебели  на сумму более 100000 рублей
                                        </h3>
                                        <div class="fat f_left pt10">
                                            <span class="mind">58</span>
                                            <span class="like">12</span>
                                        </div>
                                        <span class="overall_rating f_right">Рейтинг:
                                            <i class="star_gray">
                                                <strong class="star_gold"></strong>
                                            </i>
                                        </span>
                                        
                                    </div>
                                    <div class="sale_stock-col2 w100 padl0 f_left">
                                    <p class="sale_stock-text">
                                        При покупке мебели на сумму от 100 тыс. рублей вручается сертификат на одну неделю размещения на курорте класса ЛЮКС в Тайланде.  Проживание предоставляется на всю семью, в апартаментах вместимостью до 4 человек, со свободной датой выезда.
                                    </p>
                                    </div>
                                </div>
                                <div class="sale_stock clearfix1">
                                    <div class="sale_stock-col1 f_left">
                                        <img class="img-stock" src="images/nadivane_sale2.jpg" alt="">
                                    </div>
                                    <div class="sale_stock-col2 w42p f_left">
                                        <h3 class="img_main-text">
                                           Диваны Collezione 007 MADE IN ITALY - со скидкой!
                                        </h3>
                                        <div class="fat f_left pt10">
                                            <span class="mind">58</span>
                                            <span class="like">12</span>
                                    ...
                                    <div class="sale_stock-col2 w100 padl0 f_left">
                                    <p class="sale_stock-text">
                                        Мы рады сообщить вам что теперь в нашем магазине Надиване.РФ при покупке обеденного стола и комплекта стульев, (от 4 шт) вы получаете дополнительную скидку в размере 5%. В акции принимают участие фабрики: ВИСТА, CALLIGARIS, PRESSINI, ARRMET, GALLERIA CLASSICO
                                    </p>
                                    </div>
                                </div>
                                <div class="sale_stock clearfix1">
                                    <div class="sale_stock-col1 f_left">
                                        <img class="img-stock" src="images/nadivane_sale3.jpg" alt="">
                                    </div>
                                    <div class="sale_stock-col2 w42p f_left">
                                        <h3 class="img_main-text">
                                            Бесплатная доставка мебели при заказе от 60000 рублей.
                                        </h3>
                                        <div class="fat f_left pt10">
                                            <span class="mind">58</span>
                                            <span class="like">12</span>
                                    ...
                                    <div class="sale_stock-col2 w100 padl0 f_left">
                                    <p class="sale_stock-text">
                                        С 1.07.2012 года в нашем магазине действуют специальные условия на доставку крупногабаритной мебели при заказе свыше 60000 руб. Акция действует на доставку до подъезда. Стоимость подъема и сборки мебели оговаривается с менеджерами заранее и расчитывается по стандартному прайсу компании*.  
                                    </p>
                                    </div>
                                </div>
                                <div class="sale_stock clearfix1">
